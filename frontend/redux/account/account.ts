const SET_ACCOUNTS = "campaigns/SET_ACCOUNTS"
const SET_ACCOUNT = "campaigns/SET_ACCOUNT"
...
export const setAccountAction = (payload: any) => ({
    type: SET_ACCOUNT,
    payload,
})

// reducer
export const accountReducer = (state: any = initialState, action: any = undefined) => {
    switch (action.type) {
        case SET_ACCOUNTS:
            return {
                ...state,
